...
INSERT INTO `user` (`ID`, `Account`, `Password`, `guid`) VALUES
(1, 'jayger1132', '*304213C979C23BA1E731B1E67378AE7D3AA969D9', '70c53d7f3e54dea1c7f279d1c677d63e'),
(2, 'root', '*4ACFE3202A5FF5CF467898FC58AAB1D615029441', '7c043fbb0ad73acd598e5b075d1b90f0'),
(3, 'jayger1132', 'jayger123', 'NUll'),
(4, 'root', 'admin', 'NULL'),
(5, 'admin', 'admin', NULL),
(7, '1', '1', NULL);
...
('Jay', '[{\"db\":\"authentication\",\"table\":\"user\"},{\"db\":\"authentication\",\"table\":\"susers\"},{\"db\":\"authentication\",\"table\":\"u\"},{\"db\":\"test\",\"table\":\"movie\"}]'),
('root', '[{\"db\":\"test\",\"table\":\"movie\"}]');
...
('Jay', '2021-01-04 17:54:05', '{\"lang\":\"zh_CN\",\"Console\\/Mode\":\"collapse\"}'),
('root', '2020-10-26 21:03:33', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"zh_CN\"}');
